...
class ConfigSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $companyInfos = [
            ...
            ['key' => 'ceo_name',                'value' => 'PHÙNG TUẤN ĐẠT',                                                                                                                                'group' => 'general'],
            ['key' => 'founding_year',           'value' => '2019',                                                                                                                                           'group' => 'general'],
            ['key' => 'tagline',                 'value' => 'Hướng tới khách hàng lối sống khỏe mạnh thông qua dịch vụ ăn uống an toàn và chất lượng.',                                                      'group' => 'general'],
            ['key' => 'address',                 'value' => 'Thôn Vọng Đông, xã Yên Trung, tỉnh Bắc Ninh',                                                                                                  'group' => 'contact'],
            ['key' => 'phone',                   'value' => '0914026138 - 0389985150',                                                                                                                        'group' => 'contact'],
            ['key' => 'email',                   'value' => 'datphatnutrition@gmail.com',                                                                                                                     'group' => 'contact'],
            ['key' => 'website',                 'value' => 'datphatnutrition.com',                                                                                                                           'group' => 'contact'],
