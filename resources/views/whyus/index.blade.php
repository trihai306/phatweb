                ...
                <div class="flex-1 min-w-0">
                    ...
                    @if(isset($statistics) && count($statistics) > 0)
                        <div class="relative bg-gradient-to-br from-secondary to-dark rounded-2xl p-8 md:p-12 overflow-hidden">
                            ...
                            <div class="relative">
                                <p class="text-white/60 text-xs font-bold uppercase tracking-widest mb-2">Thống kê</p>
                                ...
                                @endphp
                                <div class="grid grid-cols-2 md:grid-cols-{{ min(count($statistics), 4) }} gap-6 md:gap-8">
