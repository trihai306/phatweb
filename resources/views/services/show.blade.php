            ...
            <div class="flex flex-col lg:flex-row gap-8 xl:gap-10">
                ...
                <article class="flex-1 min-w-0">
                    ...
                    <div class="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8"
                        ...
                        @php
                            $highlights = [
                                ['value' => '3+', 'label' => 'Năm kinh nghiệm', 'icon' => '<svg class="w-5 h-5" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M12 6v6h4.5m4.5 0a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>'],
